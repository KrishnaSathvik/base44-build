...
test('presents VensaOS workspace setup while keeping customer product fields distinct', () => {
  ...
  expect(screen.getByText('Create a feedback board for your product.')).toBeVisible();
  expect(screen.getByLabelText('Product name')).toHaveAttribute('placeholder', 'TrailVerse');
});
