...
vi.mock('@/lib/api', () => ({
  accessTrackingPage: vi.fn().mockResolvedValue({
    reportType:'bug', originalDescription:'My report', publicCode:'FI-1', issueTitle:'Issue', status:'open',
    publicResolutionNote:null, submittedAt:'2026-01-01T00:00:00Z', activity:[],
    context:{browserName:'Safari',browserVersion:'18',operatingSystem:'iOS',deviceType:'iPhone',screenWidth:390,screenHeight:844,viewportWidth:390,viewportHeight:720,pageUrl:'/chat'},
    attachments:[{accessKey:'own-key',fileName:'mine.png',mimeType:'image/png',sizeBytes:20,width:390,height:720}],
  }),
